...
{
    public string Ho_ten, Ma_so = "", Ten_Dang_nhap, Mat_khau;
    public List<XL_NGUOI_DUNG_NOI_BO> Danh_sach_Nguoi_dung = new List<XL_NGUOI_DUNG_NOI_BO>();
    public List<XL_NGUOI_DUNG_NOI_BO> Danh_sach_Nguoi_dung_Xem = new List<XL_NGUOI_DUNG_NOI_BO>();
    public List<XL_NGUOI_DUNG_NOI_BO> Danh_sach_Nguoi_dung_Chon = new List<XL_NGUOI_DUNG_NOI_BO>();
    // Chức năng 
