...
public partial class XL_UNG_DUNG
{
    ...
    void Khoi_dong_Du_lieu_Ung_dung()
    {
        ...
        var Khach_Tham_quan = new XL_NGUOI_DUNG_NOI_BO() { Ho_ten = "Khách Tham quan", Ma_so = "KHACH_THAM_QUAN" };
    ...
    public XL_LAP_TRINH_VIEN Khoi_dong_Lap_trinh_vien()
    {
        ...
        if (Lap_trinh_vien == null)
        {
            ...
            Lap_trinh_vien.Danh_sach_Nguoi_dung = Ung_dung.Du_lieu_Ung_dung.Danh_sach_Nguoi_dung_Noi_bo;
    ...
    public string Khoi_dong_MH_Chinh()
    {
        ...
        Lap_trinh_vien.Danh_sach_Nguoi_dung_Chon = new List<XL_NGUOI_DUNG_NOI_BO>();
    ...
    public string Chon_Nguoi_dung(string Ma_so_Nguoi_dung)
    {
        ...
        var Chuoi_HTML = "";
        if (Nguoi_dung.Ma_so == "KHACH_THAM_QUAN")
        {
            var Dia_chi_Xu_ly = $"http://localhost:63413/1-Man_hinh_Giao_dien/MH_Chinh.cshtml";
            Chuoi_HTML = $"<iframe " +
                        $"src='{Dia_chi_Xu_ly}' " +
                         $"style='width:100%;height:1000vh;border:none'" +
                $"></iframe>";
        }
        else if (Nguoi_dung.Nhom_Nguoi_dung.Ma_so == "NHAN_VIEN_BAN_VE")
        {
...
public partial class XL_UNG_DUNG
{    
    public   List<XL_NGUOI_DUNG_NOI_BO> Tra_cuu_Nguoi_dung(
         string Chuoi_Tra_cuu, List<XL_NGUOI_DUNG_NOI_BO> Danh_sach)
    {
